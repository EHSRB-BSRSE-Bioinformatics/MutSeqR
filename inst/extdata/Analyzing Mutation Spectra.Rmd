...
output:
  rmarkdown::html_document:
    ...
    code_download: yes
    css: custom.css
bibliography: Analyzing Mutation Spectra.bib
---
...
*Example 1. In our example data, we are studying the mutagenic effect of*
...
*along with non-snv variants, of each of the three dose groups to the control.*
...
*Example 2. Determine the COSMIC SBS signatures associated with each BaP*
*dose group.*
...
*Example 3. Analyze the COSMIC SBS signatures contributing to each of the*
...
*Example 8. Plot the base_6 mutation spectra per sample, with hierarchical*
