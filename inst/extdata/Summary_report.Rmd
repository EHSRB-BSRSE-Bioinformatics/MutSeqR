...
```{r bmd-exphill-plot1, eval=params$bmd & params$bmd_method == "proast" & !no_mf, fig.cap=caption1}
replayPlot(bmd$mf_min_Expon_HILL)
```

```{r bmd-exphill-plot2, eval=params$bmd & params$bmd_method == "proast" & plot_max & !no_mf, fig.cap=caption2}
...
```{r bmd-invln-plot1, eval=params$bmd & params$bmd_method == "proast" & !no_mf, fig.cap=caption1}
replayPlot(bmd$mf_min_InvExp_LN)
```

```{r bmd-invln-plot2, eval=params$bmd & params$bmd_method == "proast" & plot_max & !no_mf, fig.cap=caption2}
...
```{r bmd-boot-plot1, eval=params$bmd & params$bmd_method == "proast" & !plot_max & !no_mf, fig.cap=caption1}
