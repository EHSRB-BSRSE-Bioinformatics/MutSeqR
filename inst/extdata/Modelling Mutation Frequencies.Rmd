...
### Example 1.1 Model by Dose {.tabset}

*Example 1.1. Model the effect of dose on MF. Our example data consists of 24*
...
### Example 1.2 Model by Dose and Target {.tabset}

*Example 1.2 Model the effects of dose and genomic locus on MF. Sequencing for*
