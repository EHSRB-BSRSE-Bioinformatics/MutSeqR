...
## 96-Base Trinucleotide Spectrum

```{r trinucleotide-plots}
##** We want these to display in the report.
## I don't know how i will get each plot to tabset....
...
```{r glmm-residuals-hist, eval=params$do_regions_analysis}
...
```{r glmm-residuals-qq, eval=params$do_regions_analysis}
...
```{r plot-glmm, eval=params$do_regions_analysis, fig.width=fig_width, fig.height=fig_height}
