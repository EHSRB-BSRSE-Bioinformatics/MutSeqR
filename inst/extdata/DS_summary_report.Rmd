...
cpg_mutations <- get_CpG_mutations(get_seq(species = dupseq_species,
                                           ...
                                           regions_file = "mouse"), mutation_data)
...
# Aggregate by sample
sigminer_results <- signature_analysis_sigminer(mutation_data, project_name = project, group = "sample",
                        project_genome = "BSgenome.Mmusculus.UCSC.mm10", run_bootstrapping = T)
...
sigminer::show_sig_bootstrap_exposure(sigminer_results$bootstrap_results)
sigminer::show_sig_bootstrap_error(sigminer_results$bootstrap_results)
sigminer::show_sig_bootstrap_stability(sigminer_results$bootstrap_results)

sigminer::show_catalogue(t(sigminer_results$tally_results$nmf_matrix), style = "cosmic", x_label_angle = 90)
