...
params:
  ...
  rg_sep:
    ...
    value: "\t"
  is_0_based_rg:
    label: "The cutsom regions file is 0-based"
    input: checkbox
    value: TRUE
...
```{r Set Directories, message=TRUE}
if (is.null(params$projectdir) || params$projectdir == "") {
...
if (!dir.exists(project_dir)) {
  dir.create(project_dir, recursive = TRUE, showWarnings = TRUE)
}
knitr::opts_knit$set(root.dir = project_dir)

if (is.null(params$output_path) || params$output_path == "") {
...
```{r retrieve-parameter-profiles, echo = TRUE}
...
```{r filter-mutation-data, echo=TRUE, message=TRUE, eval = FALSE}
