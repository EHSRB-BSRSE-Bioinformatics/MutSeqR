...
# Import PRC BM data
mut_data <- "../../../Test Data/prj00125_PRC_BM_variant-calls.genome.mut"
vcf_data <- "C:/Users/ADODGE/OneDrive - HC-SC PHAC-ASPC/Documents/DupSeq R Package Building/Test Data/vcf files/Small test"
sample_data <- "../../../Test Data/PRC_BM_sample_data.txt"
...
my_regions <- get_seq(regions = species, padding = 0) # Grab target sequences
