...
params:
  ...
  mut_data: 
    ...
    value: "../../data/prj00125_PRC_BM_variant-calls.genome.mut"
  sample_data:
    label: "Select your Sample Data File"
    input: file
    accept: [.txt, .csv, .xlsx]
    value: "../../data/PRC_BM_sample_data.txt"
  contrasts_files:
    label: "Select your contrasts table(s)"
    input: file
    accept: [.txt]
    multiple: true
    value: "../../data/Annette Dodge 2023/dose_contrast_table.txt"
  contrasts:
...
trinuc__indiv <- calculate_mut_freq(data = mutation_data,
                                    cols_to_group = "sample",
                                    subtype_resolution = "base_96",
                                    variant_types = "snv"
                                    )

trinuc_group <- calculate_mut_freq(data = mutation_data,
...
model_by_dose <- model_mf(mf_data = MF_per_sample,
                          ...
                          contrast_table_file = params$contrasts)
model_by_dose$point_estimates
model_by_dose$pairwise_comparisons
model_by_dose$residuals_histogram

# BMD modelling by Dose
