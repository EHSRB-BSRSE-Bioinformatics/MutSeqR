...
mutation_data <-
  import_mut_data(mut_file = file.path("../../data/Jonatan_Mutations_in_blood_and_sperm_samples_221021_MM.txt"),
                  regions_file = file.path("../../inst/extdata/genic_regions_hg38.txt"),
