...
Table: Required columns for mutation data import. {.striped .hover #tbl-required-columns}
...
Table: Definitions of Variation types. {.striped .hover #tbl-variation-types}
...
Table: Definitions of Mutation data columns. {.striped .hover #tbl-mut-columns}
...
Table @tbl-required-columns. Therefore, we have implemented some default
...
Table: Predefined column name synonyms. Synonyms will be automatically changed to the default Column value upon import. {.striped .hover #tbl-name-sym} 
...
#| tbl-cap: "datatable {.striped .hover #tbl-datatable}"
...
Table: Definitions of mutation subtype resolutions. {.striped .hover #tbl-subtypes}
...
Table: Subtype Resolutions and their associated subtype/context columns. {.striped .hover #tbl-subtypes-cols} 
...
::: {.scroll-box style="overflow-x: auto; overflow-y: auto; max-height: 400px;"}
Table: Output files from SigProfilerMatrixGenerator by folder. {.striped .hover #tbl-mat-files}
...
Table: SigProfiler transcriptional bias categories. {.striped .hover #tbl-transcript-cat}
...
::: {.striped .hover #tbl-assignment-output layout-ncol=1 }
...
Table: Activities {.striped .hover #tbl-activities}
...
Table: Signatures {.striped .hover #tbl-signatures}
...
Table: Solution stats {.striped .hover #tbl-solution-stats}

Signature assignment output files.
:::
