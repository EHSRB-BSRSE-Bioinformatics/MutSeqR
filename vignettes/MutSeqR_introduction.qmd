...
: Required columns for mutation data import. {.striped .hover #tbl-required-columns}
...
: Definitions of Variation types. {.striped .hover #tbl-variation-types}
...
: Definitions of Mutation data columns. {.striped .hover #tbl-mut-columns}
...
: Predefined column name synonyms. Synonyms will be automatically changed to the default Column value upon import. {.striped .hover #tbl-name-sym} 
...
: Definitions of mutation subtype resolutions. {.striped .hover #tbl-subtypes}
...
: Subtype Resolutions and their associated subtype/context columns. {.striped .hover #tbl-subtypes-cols} 
...
: Output files from SigProfilerMatrixGenerator by folder. {.striped .hover #tbl-mat-files}
...
: SigProfiler transcriptional bias categories. {.striped .hover #tbl-transcript-cat}
...
: Activities {.striped .hover #tbl-activities}
...
: Signatures {.striped .hover #tbl-signatures}
...
: Solution stats {.striped .hover #tbl-solution-stats}
