...
: Required columns for mutation data import. {#tbl-required-columns}
...
: Definitions of Variation types. {#tbl-variation-types}
...
: Definitions of Mutation data columns. {#tab-mut-columns}
...
Table @ref(tbl-required-columns). Therefore, we have implemented some default
...
: Predefined column name synonyms. Synonyms will be automatically changed to the default Column value upon import. {tbl-name-sym} 
...
: Definitions of mutation subtype resolutions. {tbl-subtypes}
...
: Subtype Resolutions and their associated subtype/context columns. {tbl-subtypes-cols} 
...
: Output files from SigProfilerMatrixGenerator by folder. {tbl-mat-files}
...
: SigProfiler transcriptional bias categories. {tbl-transcript-cat}
...
::: {#tab-assignment-output layout-ncol=1 }
...
: Solution stats {#tbl-solution-stats}
